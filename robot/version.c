...
const char * V_SLOCAL_REVISION="39";
const char * V_SREVISION="6e87f6ed5b99";
const char * V_STAG="2021.01 +39";
...
const uint32_t V_REVISION_0=0x6e87f6ed;
const uint16_t V_REVISION_1=0x5b99;
